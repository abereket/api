...
class JobController extends Controller{
    ...
    public function update(Request $request,$jobId){
        ...
        $rules = ['user_id'=>'required|integer','external_id'=>'sometimes|required|string|max:60|unique:jobs','title'=>'sometimes|required|string|max:50','company_name'=>'sometimes|required|string|max:50',
